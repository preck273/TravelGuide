...
import useStyles from './stylesPD';
   ...
   //console.log(place);
    ...
    return (
        <Card elevation={6}>
            <CardMedia 
                style={{ height: 350}}
                image={place.photo ? place.photo.images.large.url: 'https://ze-news.fr/wp-content/uploads/scandic-sundsvall-city-restaurant-verket-10.jpg'}
                title={place.name}
            />
            <CardContent>
